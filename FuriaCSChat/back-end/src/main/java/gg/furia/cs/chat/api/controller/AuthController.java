...
import gg.furia.cs.chat.api.dto.user.UserLoginDTO;
import gg.furia.cs.chat.api.dto.user.UserRegisterDTO;
...
public class AuthController {
    ...
    @NeedsUserContext
    public ResponseEntity<ApiResponse<Object>> refreshTokens(HttpServletResponse response) throws FuriaException {
