...
public class ContextService {
    ...
    @NonNull
    public User getUserOrThrow() throws FuriaException {
        throwIfNotAuthenticated();
        return user;
    }

    public AuthTokens refreshTokens() throws FuriaException {
    ...
    public void throwIfNotAuthenticated() throws FuriaException {
        if (!isAuthenticated()) {
            throw new FuriaException(FuriaErrorCode.COMMON_UNAUTHORIZED);
        }
    }
